...
define('ATLANTIC_FILE_TO_OPEN_CSV', './Add_On/Time_Zone/Time_Zone_Db/Data_Country_ATLANTIC.csv');
//$Zise_File_Csv = $_POST[1024]; Remplacé par constante avec DEFINE
define('ATLANTIC_SIZE_FILE_CSV', 100000);
//$Delimiter_Csv = $_POST[","]; Remplacé par constante avec DEFINE
define('ATLANTIC_DELIMITER_CSV', ",");
//$Enclosure_Csv = $_POST["'"]; Remplacé par constante avec DEFINE
define('ATLANTIC_ENCLOSURE_CSV', "'");
//$Escape_Csv = $_POST[""]; Remplacé par constante avec DEFINE
define('ATLANTIC_ESCAPE_CSV', ";");
/* Call listing csv file */
Atlantic_Full_Listing_Time_Zone();
//session_write_close();
